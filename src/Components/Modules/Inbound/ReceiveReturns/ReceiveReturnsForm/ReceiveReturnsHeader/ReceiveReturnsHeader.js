...
import { ConsigneeInfoForm } from './ConsigneeInfo';
...
function Header(props) {
    ...
    useEffect(() => {
        if (tabRef.current) {
            tabRef.current.value = currentTab;
        }
    }, [tabRef, currentTab])
    ...
    return (
        <Paper className={classes.root} elevation={0}>
            ...
            >
                ...
                <Tab label="Consignee" {...a11yProps(1)} />
            ...
            <TabPanel value={currentTab} index={1}>
                <ConsigneeInfoForm returnsHdrData={returnsHdrData} clearValue={clearValue} />
            </TabPanel>
            <TabPanel value={currentTab} index={2}>
                <CarrierInfoForm  docHdrData={returnsHdrData} clearValue={clearValue} />
            </TabPanel>
...
export const ReceiveReturnsHeader = React.memo(Header)
