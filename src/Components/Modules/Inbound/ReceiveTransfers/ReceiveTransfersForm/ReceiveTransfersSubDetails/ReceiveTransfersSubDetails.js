...
import { TransferredItemsTable } from './TransferredItemsTab/TransferredItemsTable';
import { TransferredItemDetails } from './TransferredItemsTab/TransferredItemDetails';
...
function SubDetails(props) {
    const { whTransferId, hideItemDetails, setHideItemDetails, selectedItem, setSelectedItem, clearValue, setReloadHdrTable, setSoftReloadHdrTable } = props;
    ...
    useEffect(() => {
        if (selectedItem.length === 0) {
            ...
            populateFields({
                ...
                whTransStatusId: selectedItem[0].whTransStatusId,
        ...
        <React.Fragment>
            <Paper className={classes.root} elevation={0}>
                <Tabs
                    ...
                    centered
                >
                    <Tab label="Transfered Item Details" {...a11yProps(0)} />
                ...
                <TabPanel value={currentTab} index={1}>
                    <POReceivedTable
                        documentNo={whTransferId}
                        documentType="WHTRANSFERS"
                        rowSelected={selectedItem}
                        setRowSelected={setSelectedItem}
                        reload={reload}
                        setReload={setReload}
...
export const ReceiveTransfersSubDetails = React.memo(SubDetails);