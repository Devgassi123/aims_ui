        ...
        <React.Fragment>
            <Paper className={classes.root} elevation={0}>
                ...
                <CentralizedTextField
                    ...
                    label="Expected Qty."
                    type="number"
                    disabled={selectedItem.length > 0 && selectedItem[0].whTransLineStatusId !== "CREATED"}
                // required //commented to be able to save the returns without item details
                />
                <CentralizedTextField
                    id="qtyToReceived"
                ...
                />
                <CentralizedTextField
                    id="whTransLineStatusId"
                    name="whTransLineStatusId"
                    label="Status ID"
                    disabled
...
export const TransferredItemDetails = React.memo(Details)