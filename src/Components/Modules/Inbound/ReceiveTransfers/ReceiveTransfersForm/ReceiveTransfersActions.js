...
import {
    Add as AddIcon, Check as CheckIcon, Clear as ClearIcon, 
...
export default function ReceiveTransfersActions(props) {
    const { isDisabled, handleClickCancel, handleClickNewItem } = props;
