...
import { CarrierInfoForm } from './CarrierInfo';
...
function Header(props) {
    const { poHdrData, clearValue } = props;
    ...
    return (
        <Paper className={classes.root} elevation={0}>
            ...
            <TabPanel value={currentTab} index={1}>
                <SupplierInfoForm poHdrData={poHdrData} clearValue={clearValue} />
            </TabPanel>
            <TabPanel value={currentTab} index={2}>
                <CarrierInfoForm docHdrData={poHdrData} clearValue={clearValue} />
            </TabPanel>
...
export const POHeader = React.memo(Header)
