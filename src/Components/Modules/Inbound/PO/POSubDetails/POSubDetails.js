...
import { POItemsTable } from './POOrdersTab/POItemsTable';
import POItemDetails from './POOrdersTab/POItemDetails';
import { populateFields } from '../../../../../Functions/Util';
import { useRef } from 'react';
import { POReceivedTable } from './POReceivedTab/POReceivedTable';
...
function SubDetails(props) {
    const { poId, hideItemDetails, setHideItemDetails, selectedItem, setSelectedItem, clearValue, setReloadHdrTable, setSoftReloadHdrTable } = props;
        ...
        <React.Fragment>
            <Paper className={classes.root} elevation={0}>
                ...
                >
                    ...
                    {/* <Tab label="Putted Away" {...a11yProps(2)} /> */}
                </Tabs>
...
export const POSubDetails = React.memo(SubDetails);