...
const headCells = [
    { id: 'productConditionId', numeric: false, disablePadding: false, label: 'ID' },
    { id: 'productCondition', numeric: false, disablePadding: false, label: 'Product Condition' },
...
function EnhancedTable(props) {
    ...
    const [orderBy, setOrderBy] = React.useState('productConditionId');
    ...
    const handleRowClick = (event, row) => {
        const selectedIndex = rowSelected.findIndex((row) =>  row.productConditionId === row.id);
        let newSelected = [];
    ...
    const isRowSelected = (id) => rowSelected.findIndex((row) =>  row.productConditionId === id) !== -1;
                            ...
                            {loading
                                ...
                                : rows.length === 0
                                    ...
                                    : stableSort(rows, getComparator(order, orderBy))
                                        ...
                                        .map((row, index) => {
                                            const isRowItemSelected = isRowSelected(row.productConditionId);
...
export const ProductConditionsTable = React.memo(EnhancedTable);
