...
import ProductListFilter from "../Modules/Product/ProductList/ProductListFilter";
...
const EnhancedTableToolbar = (props) => {
    ...
    const { numSelected, handleOpenFilter, handleDelete } = props;
...
function EnhancedTable(props) {
    const { data, rowSelected, setRowSelected, funcDelete } = props;
    ...
    return (
        <div className={classes.root}>
            <ProductListFilter open={openFilter} handleClose={handleCloseFilter} />
            <Paper className={classes.paper}>
                <EnhancedTableToolbar numSelected={selected.length} handleOpenFilter={handleOpenFilter} handleDelete={funcDelete} />
                                ...
                                : rows.length === 0
                                    ...
                                    : stableSort(rows, getComparator(order, orderBy))
                                        ...
                                        .map((row, index) => {
                                            ...
                                            const isRowItemSelected = isRowSelected(row.product_id);
                                            ...
                                            return (
                                                <TableRow
                                                    ...
                                                    tabIndex={-1}
                                                    key={row.product_id}
                                                    onClick={(event) => handleRowClick(event, row.product_id)}
...
export const MultipleItemSelectorTable = React.memo(EnhancedTable);
